...
class PretrainVisionTransformerEncoder(nn.Module):
    ...
    def forward(self, x, mask):
        ...
        x = self.head(x)        # head is nn.Identity()
        return x
...
class PretrainVisionTransformer(nn.Module):
    ...
    def forward(self, x, mask):
        ...
        x_vis_encoder = self.encoder(x, mask) # [B, N_vis, C_e]
        x_vis = self.encoder_to_decoder(x_vis_encoder) # [B, N_vis, C_d]
