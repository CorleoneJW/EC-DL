...
class TensorboardLogger(object):
    def __init__(self, log_dir, resume_step):
        self.writer = SummaryWriter(logdir=log_dir, purge_step=resume_step)
...
def save_model(args, epoch, model, model_without_ddp, optimizer, loss_scaler, model_ema=None, true_epoch=None, em_info=None):
    ...
    if loss_scaler is not None:
        ...
        for checkpoint_path in checkpoint_paths:
            ...
            if true_epoch is not None:
                to_save['true_epoch'] = true_epoch

            if em_info is not None:
                to_save['em_info'] = em_info
...
def get_optimizer(config, model):
    assert config.optimizer in ['Adadelta', 'Adagrad', 'Adam', 'AdamW', 'Adamax', 'ASGD', 'RMSprop', 'Rprop', 'SGD'], 'Unsupported optimizer!'
